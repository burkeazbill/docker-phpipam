...
INSERT INTO `api` VALUES (1,'rest','d02c45b90877cdbb94c33b4c7e538350',3,NULL,'none',1,90,1,1);
...
INSERT INTO `lang` VALUES (1,'en_GB.UTF-8','English'),(2,'sl_SI.UTF-8','Slovenš?ina'),(3,'fr_FR.UTF-8','Français'),(4,'nl_NL.UTF-8','Nederlands'),(5,'de_DE.UTF-8','Deutsch'),(6,'pt_BR.UTF-8','Brazil'),(7,'es_ES.UTF-8','Español'),(8,'cs_CZ.UTF-8','Czech'),(9,'en_US.UTF-8','English (US)'),(10,'ru_RU.UTF-8','Russian'),(11,'zh_CN.UTF-8','Chinese');
...
INSERT INTO `logs` VALUES (1,1,'2017-07-21 20:42:26','','172.21.0.1','Database installation','Database installed successfully. Version 1.3.000 installed'),(2,0,'2017-07-21 20:43:53','admin','172.21.0.1','User login','User phpIPAM Admin logged in'),(3,0,'2017-07-21 20:48:06','Admin','172.21.0.1','settings object 1 edit','Object id=1 in settings edited id: 1 siteTitle: Rainpole IPAM siteDomain: domain.local siteURL: http://ipam.rainpole.com:8181/ siteLoginText: NULL prettyLinks: No defaultLang: 0 inactivityTimeout: 3600 siteAdminName: Sysadmin siteAdminMail: administrator@rainpole.com api: 1 enableIPrequests: 1 enableMulticast: 0 enableRACK: 1 enableLocations: 1 enableSNMP: 0 enablePSTN: 0 enableThreshold: 1 enableVRF: 0 enableDNSresolving: 0 vlanDuplicate: 1 decodeMAC: 1 vlanMax: 4096 enableChangelog: 1 tempShare: 0 enableNAT: 1 enablePowerDNS: 0 updateTags: 1 enforceUnique: 1 enableFirewallZones: 0 maintaneanceMode: 0 link_field: NULL log: Database donate: 1 visualLimit: 24 subnetOrdering: subnet,asc subnetView: 0 scanPingType: ping pingStatus: 1800;3600 scanPingPath: /bin/ping scanFPingPath: /bin/fping scanMaxThreads: 128'),(4,0,'2017-07-21 20:49:28','Admin','172.21.0.1','api object creation','New api database object created id: NULL app_id: rest app_code: d02c45b90877cdbb94c33b4c7e538350 app_permissions: 3 app_security: none app_lock: 1 app_lock_wait: 90 app_nest_custom_fields: 1 app_show_links: 1 app_comment: NULL'),(5,0,'2017-07-21 20:51:53','Admin','172.21.0.1','User logged out','User Admin has logged out'),(6,0,'2017-07-21 20:51:58','admin','172.21.0.1','User login','User phpIPAM Admin logged in'),(7,0,'2017-07-21 20:55:57','Admin','172.21.0.1','users object 1 edit','Object id=1 in users edited id: 1 real_name: phpIPAM Admin username: Admin email: admin@domain.local role: Administrator authMethod: 1 lang: 9 mailNotify: No mailChangelog: No editVlan: Yes pstn: NULL pdns: NULL groups: NULL'),(8,0,'2017-07-21 20:58:38','admin','172.21.0.1','User login','User phpIPAM Admin logged in'),(9,0,'2017-07-21 20:58:38','','172.21.0.1','users object 1 edit','Object id=1 in users edited id: 1 token: o3$B6Ua9xJjnDEt.W%vHiJj$ token_valid_until: 2017-07-22 02:58:38'),(10,0,'2017-07-21 21:05:02','admin','172.21.0.1','User login','User phpIPAM Admin logged in'),(11,0,'2017-07-21 21:05:02','','172.21.0.1','users object 1 edit','Object id=1 in users edited id: 1 token_valid_until: 2017-07-22 03:05:02'),(12,0,'2017-07-21 21:05:50','admin','172.21.0.1','User login','User phpIPAM Admin logged in'),(13,0,'2017-07-21 21:05:50','','172.21.0.1','users object 1 edit','Object id=1 in users edited id: 1 token_valid_until: 2017-07-22 03:05:50'),(14,0,'2017-07-21 21:37:52','admin','172.21.0.1','User login','User phpIPAM Admin logged in');
...
INSERT INTO `settings` VALUES (1,'Rainpole IPAM','Sysadmin','administrator@rainpole.com','domain.local','http://ipam.rainpole.com:8181/',NULL,0,1,0,0,0,'{\"zoneLength\":3,\"ipType\":{\"0\":\"v4\",\"1\":\"v6\"},\"separator\":\"_\",\"indicator\":{\"0\":\"own\",\"1\":\"customer\"},\"zoneGenerator\":\"2\",\"zoneGeneratorType\":{\"0\":\"decimal\",\"1\":\"hex\",\"2\":\"text\"},\"deviceType\":\"3\",\"padding\":\"on\",\"strictMode\":\"on\",\"pattern\":{\"0\":\"patternFQDN\"}}',0,NULL,0,'{\"type\":\"kea\",\"settings\":{\"file\":\"/etc/kea/kea.conf\"}}',0,1,0,1,1,1,0,NULL,'1.3','1',1,'mac;owner;state;switch;note;firewallAddressObject',1,4096,'subnet,asc',24,0,'1800;3600',0,'2017-07-21 20:48:06','2017-07-21 20:43:54','1',1,'/bin/ping','/bin/fping','ping',128,'No',NULL,3600,1,1,0,0,1,0,NULL,'Database',0);
...
CREATE TABLE `users` (
  ...
  `password` char(128) CHARACTER SET latin1 COLLATE latin1_bin DEFAULT NULL,
  `groups` varchar(1024) CHARACTER SET latin1 COLLATE latin1_bin DEFAULT NULL,
  ...
  `widgets` varchar(1024) CHARACTER SET latin1 COLLATE latin1_bin DEFAULT 'statistics;favourite_subnets;changelog;top10_hosts_v4',
  `lang` int(11) unsigned DEFAULT 9,
  `favourite_subnets` varchar(1024) CHARACTER SET latin1 COLLATE latin1_bin DEFAULT NULL,
  ...
  `token` varchar(24) CHARACTER SET latin1 COLLATE latin1_bin DEFAULT NULL,
...
INSERT INTO `users` VALUES (1,'Admin',1,'$6$rounds=3000$fn8n0Z7ak20KQag3$HQLeCAzzEGVEZG6RlvsrdVEquL9JgrAPViYQbbKKTGsNuIIUdR.q8X.xXR7fvbn6b0LRq/Zrr35arqyV/zUKa/',NULL,'Administrator','phpIPAM Admin','admin@domain.local',NULL,'Yes',NULL,'0','statistics;favourite_subnets;changelog;access_logs;error_logs;top10_hosts_v4',9,NULL,'No','No','No','2017-07-21 21:05:50','2017-07-21 21:37:52','2017-07-21 21:38:01','default',0,'Dynamic','o3$B6Ua9xJjnDEt.W%vHiJj$','2017-07-22 03:05:50');
...
-- Dump completed on 2017-07-21 21:45:03
